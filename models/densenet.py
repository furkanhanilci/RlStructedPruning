"""
Implementation of the DenseNet model, inspired by the architecture proposed in:
...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, in_channels=3, num_classes=100):
        super().__init__()
